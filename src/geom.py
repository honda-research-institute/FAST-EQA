...
def pixel2world(x, y, depth, cam_intr, cam_pose):
    """
    x, y: Pixel coordinates
    depth: depth at (x, y) in meters
    cam_intr: [3x3] intrinsic matrix
    cam_pose: [4x4] camera extrinsics (world_from_camera)
    """
    ...
    point_world = cam_pose @ point_cam  # [4x1]
